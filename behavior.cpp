...
Behavior::Behavior()
{
	...
	(*this).containing_Object_Pointer = nullptr;
}
...
void Behavior::display_Information()
{
	...
	std::cout << "containing_Object_Pointer = " << (*this).containing_Object_Pointer << std::endl;
	...
	std::cout << "Size of containing_Object_Pointer = " << sizeof((*this).containing_Object_Pointer) << std::endl;
...
void Behavior::set_Containing_Object_Pointer(Object* containing_Object_Pointer)
{
	(*this).containing_Object_Pointer = containing_Object_Pointer;
}

const Object* Behavior::get_Containing_Object_Pointer()
{
	return (*this).containing_Object_Pointer;
}
